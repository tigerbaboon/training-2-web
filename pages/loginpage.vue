  ...
  <div class="bg-gray-100 flex w-full h-screen items-center justify-center">
    <div class="w-[1340px] h-[750px]">
      <div class="grid grid-cols-2">
        <div class="bg-rose-500 h-[650px] bg-[url('/assets/login/IMG_3037.JPEG')] bg-cover rounded-r-[170px]"></div>
          ...
          <div class="bg-white w-[600px] h-[600px]">
            ...
            <div class="flex p-2 justify-center">
              <div class="flex flex-col text-[20px]">
                ชื่อผู้ใช้
                <input class="w-[300px] h-[40px] p-2 border border-gray-400" type="text" v-model="input_username"
            ...
            <div class="flex justify-center">
              <div class="flex flex-col text-[20px]">
                รหัสผ่าน
                <input class="w-[300px] h-[40px] p-2 border border-gray-400" type="password" v-model="input_password"
            ...
            <div class="flex justify-center">
              <button @click="checkLogin" class="bg-[#00AEEF] w-[300px] rounded-full p-2 text-white">
                ยืนยัน
              </button>
            </div>
