<template>
    <div class="flex justify-center w-full " v-for="(list, x) in lists" :key="x">
        <div class="flex xl:w-[1600px] lg:w-full">
                ...
                <div class="w-full flex justify-center lg:px-2">
                    ...
                    <div class="xl:py-6  " v-if="activeTab === 'fromDetail'">
                        ...
                        <div class="space-y-3 flex flex-col items-center">
                            ...
                            <div>
                                <label for="ราคา"
                                    class="block text-gray-900 xl:text-[24px] lg:text-[18px]">ราคา</label>
                            ...
                            <div class="grid grid-cols-2 gap-x-4 gap-y-2 xl:w-[390px] lg:w-[320px]">
                                ...
                                <div>
                                    ...
                                    <!-- <input id="ชั้น" v-model="form.floor" type="number" min="0" placeholder="จำนวนชัั้น"
                                        class="w-full xl:h-[40px] lg:h-[32px] shadow-lg outline-sky-300 border-[1px] rounded-md border-gray-200 xl:text-[20px] lg:text-[16px] px-2"
                                        @input="checkNumber('floor')"> -->
                    ...
                    <div class="flex flex-col gap-5 mt-5" v-if="activeTab === 'inputImage'">
                        <div class=" border-[2px] border-sky-400 rounded-md xl:p-6 lg:p-3 xl:w-[390px] lg:w-[320px]">
                        ...
                        <!-- <div class="w-full flex justify-end">
                            <button @click="delimg"
                                ...
                                <Icon class="h-5 w-5 mr-2" name="fluent:delete-16-regular" />
                                ลบรูปหน้าปก
                            </button>
                            <button @click="delimg">ลบรูปหน้าปก</button>
                        </div> -->
                        <div class=" border-[2px] border-green-400  rounded-md xl:p-6 lg:p-3 xl:w-[390px] lg:w-[320px]">
                            <p class="xl:text-[24px] lg:text-[18px] text-center ">
                        ...
                        <!-- <div class="w-full flex justify-end">
                            <button @click="delimg2()"
                                class="w-[125px] inline-flex justify-center items-center px-4 py-2 bg-red-600  hover:bg-red-700 text-white text-sm font-medium rounded-md  ">
                                <Icon class="h-5 w-5 mr-2" name="fluent:delete-16-regular" />
                                ลบรูป
                            </button>
                        </div> -->
            ...
            <div class="xl:w-[1130px] lg:w-[670px] bg-white xl:my-5 lg:my-2">
                <div class="border xl:ml-10 lg:ml-2 xl:my-3 lg:my-1 p-4 rounded-md  shadow-lg">
                    <div>
                        <span class=" text-gray-800 xl:text-[24px] lg:text-[18px]">ชื่อบ้านเช่า : </span>
                        <span class="text-sky-500 font-bold xl:text-[30px] lg:text-[24px] break-words">{{ nameHome
                            }}</span>
                    </div>
                    <div>
                        <span class="text-gray-800 xl:text-[24px] lg:text-[18px]">ประเภทการขาย : </span>
                        <span class="text-sky-500 font-bold xl:text-[28px] lg:text-[22px]">{{ saleType }}</span>
                    </div>
                    <div>
                        <span class="text-gray-800 xl:text-[24px] lg:text-[18px]">ประเภทที่พัก : </span>
                        <span class="text-sky-500 font-bold xl:text-[28px] lg:text-[22px] ">{{ homeType }}</span>
                    </div>
                    <div>
                        <span class="text-gray-800 xl:text-[24px] lg:text-[18px]">โซนที่พัก : </span>
                        <span class="text-sky-500 font-bold xl:text-[28px] lg:text-[22px]">{{ zoneType }}</span>
                    </div>
                    <div>
                        <span class="text-gray-800 xl:text-[24px] lg:text-[18px]">ราคาเช่า : </span>
                        <span class="text-sky-500 font-bold xl:text-[28px] lg:text-[22px]">{{ price }} </span>
                        <span v-if="price" class="text-gray-800 xl:text-[28px] lg:text-[22px]"> บาท/เดือน</span>
                    </div>
                </div>
                <!-- เเสดงรูปที่ต้องการอัพโหลด -->
                <div class="border rounded-md xl:ml-10 lg:ml-2 xl:my-3 lg:my-1 p-3 shadow-lg">
                    <p class="xl:text-[24px] lg:text-[18px] py-3">รูปภาพ</p>
                    <div class="xl:flex lg:grid lg:grid-cols-1 xl:gap-2 lg:gap-1 xl:h-[408px] lg:h-auto">
                        <div v-if="uploadedImages.length" class="xl:w-[710px] relative">
                            ...
                            <img class=" lg:w-full xl:h-[408px] lg:h-[358px] rounded-xl object-cover"
                                :src="uploadedImages[0]" alt="Uploaded" />
                        </div>
                        <!-- รูปโชว์ตอนยังไม่ได้เลือกไฟล์รูป -->
                        <div v-if="!uploadedImages.length" class="xl:w-[710px] lg:w-full xl:h-[400px] lg:h-[358px]">
                            <div
                                class="xl:w-[700px] lg:w-full xl:h-[400px] lg:h-[358px] flex justify-center xl:border-[4px] lg:border-[2px] border-gray-500 rounded-xl border-dashed">
                                <div class="flex flex-col justify-center items-center">
                                    <Icon class="xl:w-[300px] lg:w-[100px] xl:h-[300px] lg:h-[100px] text-gray-500"
                                        name="fa-regular:images" />
                                    <p class="xl:text-[50px] lg:text-[30px] text-gray-500 font-bold">No images</p>
                                </div>
                            </div>
                        </div>
                        <div class="grid grid-cols-1 gap-1 overflow-auto xl:h-auto lg:h-[720px]">
                            <div v-if="uploadedImages2.length" v-for="(image, index) in uploadedImages2.slice(0)"
                                ...
                                <img class="xl:w-[340px] xl:h-[202px] lg:h-[358px] rounded-xl object-cover "
                            ...
                            <div v-else class="xl:w-[340px] grid grid-cols-1 gap-1">
                                <div
                                    class=" w-full xl:h-[196px] lg:h-[358px] flex justify-center items-center xl:border-[4px] lg:border-[2px] border-gray-500 rounded-xl border-dashed">
                ...
                <div class="border rounded-md xl:ml-10 lg:ml-2 xl:my-3 lg:my-1 p-4  shadow-lg">
                    <p class="xl:text-[24px] lg:text-[18px]">ข้อมูลที่พัก</p>
                    <div class="grid xl:grid-cols-4 lg:grid-cols-2 lg:place-items-start">
                        <div class="flex items-center justify-center gap-2 h-[40px]">
                            <Icon class="text-sky-900 w-[30px] h-[30px]" name="ion:bed-outline" />
                            <p class="xl:text-[24px] lg:text-[18px] font-bold text-sky-500">{{ bedRoom }}</p>
                            <p class="xl:text-[24px] lg:text-[18px]">ห้องนอน</p>
                        </div>
                        <div class="flex items-center justify-center gap-2 h-[40px]">
                            <Icon class="text-sky-900 w-[30px] h-[30px]" name="mdi:bathroom" />
                            <p class="xl:text-[24px] lg:text-[18px] font-bold text-sky-500">{{ bathRoom }}</p>
                            <p class="xl:text-[24px] lg:text-[18px]">ห้องน้ำ</p>
                        </div>
                        <div class="flex items-center justify-center gap-2 h-[40px]">
                            <Icon class="text-sky-900 w-[30px] h-[30px]" name="ri:stairs-line" />
                            <p class="xl:text-[24px] lg:text-[18px] font-bold text-sky-500">{{ floor }}</p>
                            <p class="xl:text-[24px] lg:text-[18px]">ชั้น</p>
                        </div>
                        <div class="flex items-center justify-center gap-2 h-[40px]">
                            <Icon class="text-sky-900 w-[30px] h-[30px]"
                                name="material-symbols-light:background-grid-small-outline" />
                            <p class="xl:text-[24px] lg:text-[18px] font-bold text-sky-500">{{ area }}</p>
                            <p class="xl:text-[24px] lg:text-[18px]">ตร.ม.</p>
                        </div>
                    </div>
                </div>
                <div class="border rounded-md xl:ml-10 lg:ml-2 xl:my-3 lg:my-1 p-4  shadow-lg">
                    <p class="xl:text-[24px] lg:text-[18px]">อัตราค่าน้ำและค่าไฟ</p>
                    <div class="grid xl:grid-cols-2 lg:grid-cols-1 lg:place-items-start">
                        <div class="flex items-center justify-center gap-2 h-[40px]">
                            <Icon class="text-sky-900 w-[30px] h-[30px]" name="iconoir:light-bulb-on" />
                            <span class="xl:text-[24px] lg:text-[18px]">ค่าไฟ</span>
                            <p class="xl:text-[24px] lg:text-[18px] font-bold text-sky-500">{{ electricity }}</p>
                            <p class="xl:text-[24px] lg:text-[18px]">บาท/ต่อหน่วย</p>
                        </div>
                        <div class="flex items-center justify-center gap-2 h-[40px]">
                            <Icon class="text-sky-900 w-[30px] h-[30px]" name="healthicons:running-water-outline" />
                            <span class="xl:text-[24px] lg:text-[18px]">ค่าน้ำ</span>
                                    <p class="xl:text-[24px] lg:text-[18px] font-bold text-sky-500">{{ waterBill }}</p>
                            <p class="xl:text-[24px] lg:text-[18px]">บาท/ต่อหน่วย</p>
                        </div>
                    </div>
                </div>
                <div class="border rounded-md xl:ml-10 lg:ml-2 xl:my-3 lg:my-1 p-4 h-auto shadow-lg">
                    <label for="inputtext" class="xl:text-[24px] lg:text-[18px]">รายละเอียดบ้านเช่า : </label>
                ...
                <div class="border rounded-md xl:ml-10 lg:ml-2 xl:my-3 lg:my-1 p-4 h-auto shadow-lg">
                    <label for="inputaddress" class="xl:text-[24px] lg:text-[18px]">ที่อยู่ : </label>
                ...
                <div class=" border rounded-md xl:ml-10 lg:ml-2 xl:my-3 lg:my-1 p-4 shadow-lg ">
                    <p class="xl:text-[24px] lg:text-[18px] ">สิ่งอำนวยความสะดวก</p>
                    <div class=" grid xl:grid-cols-4 lg:grid-cols-2 xl:gap-x-11 lg:gap-x-1 xl:gap-y-3 lg:gap-y-[2px] "
                        v-if="selectedDevices.length">
                        <li class="xl:text-[22px] lg:text-[18px] custom-bullet" v-for="device in selectedDevices"
                            :key="device"> &nbsp;{{
                                device }}</li>

                    </div>
                </div>
                <div class="border rounded-md xl:ml-10 lg:ml-2 xl:my-3 lg:my-1 shadow-lg p-5">
                    <p class="xl:text-[24px] lg:text-[18px]">ที่ตั้ง :</p>
                    <!-- <div>
                        <iframe id="mapFrame" class="w-full h-[430px] rounded-md" style="border:0;" loading="lazy"
                    ...
                    <div>
                        <iframe
                            ...
                            class="w-full xl:h-[430px] lg:h-[250px] rounded-md" style="border:0;" loading="lazy"
                            referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>
                <div class="border rounded-md xl:ml-10 lg:ml-2 xl:my-3 lg:my-1 p-4 shadow-lg">
                    <p class="xl:text-[24px] lg:text-[18px]">ข้อมูลผู้ลงประกาศ</p>
                    <div class="grid grid-cols-1 gap-y-6">
                        <div class="flex xl:gap-4 lg:gap-1 items-center">
                            <Icon class="text-sky-900 w-[30px] h-[30px]" name="icon-park-solid:edit-name" />
                            <p class="xl:text-[24px] lg:text-[18px]">ชื่อ :</p>
                            <p class="xl:text-[24px] lg:text-[18px] text-[#2eb840] break-words whitespace-pre-line">
                                {{ nameDetail }}
                            </p>
                        </div>
                        <div class="grid grid-cols-2">
                            <div class="flex xl:gap-4 lg:gap-1 items-center">
                                ...
                                <p class="xl:text-[24px] lg:text-[18px]">เบอร์โทร :</p>
                                <p class="xl:text-[24px] lg:text-[18px] text-[#2eb840] break-words whitespace-pre-line">
                                    {{ telNumber }}
                                </p>
                            </div>
                            <div class="flex xl:gap-4 lg:gap-1 items-center">
                                ...
                                <p class="xl:text-[24px] lg:text-[18px]">ID Line :</p>
                                <p class="xl:text-[24px] lg:text-[18px] text-[#2eb840] break-words whitespace-pre-line">
                                    {{ lineID }}
                                </p>
                            </div>
...
const bedRoom = ref<number>();
const bathRoom = ref<number>();
const electricity = ref<number>();
const waterBill = ref<number>();
...
//เช็คทีเดียวโดยการใช้key
const checkNumber = (key:any) => {
    if (form.value[key] !== undefined && form.value[key] < 0) {
        form.value[key] = undefined;
    }else if(form.value[key] !== undefined && form.value[key] > 5){
        form.value[key] = 5;
    }
};
...
//เช็คที่ละตัวแปร
const checkFloor = () => {
    if (floor.value !== undefined && floor.value < 0) {
        floor.value = undefined;
    }else if(floor.value !== undefined && floor.value > 10){
        floor.value = 10;
    }
};
